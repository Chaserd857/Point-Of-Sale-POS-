...
public class RoundButton extends JButton {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Draw the outline
        g2d.setColor(new Color(197,31,49,255)); // Change this to the desired outline color
        g2d.setStroke(new BasicStroke(2)); // Change this to the desired outline thickness
